...
class Admin_MotivosController extends App_Modulo_Mantenedor_Class{
        
    /**
     * Entidad a modificar
     * @var string 
     */
    protected $_entity = "MotivoViaje";
    ...
    protected function _getFormClass($parametros){
        $form = New Admin_Form_Motivo($parametros);
        $form->renderForm();
        return $form;
    }
    ...
    protected function _getSearchForm(){
        ...
        $form = New Admin_Form_SearchMotivo($parametros);
        $form->renderForm();
